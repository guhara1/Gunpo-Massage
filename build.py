...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 군포시 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">경기도 군포시 전지역 방문 출장마사지·홈타이 안내 사이트입니다. 모든 서비스는 안내된 관리 범위와 위생·안전 기준 안에서만 제공됩니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 경기도 군포시 전지역</span>
      </address>
    </div>
    <nav class="footer-col" aria-label="지역 안내">
      <p class="footer-title">지역 안내</p>
      <ul>
        <li><a href="/gunpo/gunpo-dong-chuljangmassage/">군포동 출장마사지</a></li>
        <li><a href="/gunpo/sanbon-dong-chuljangmassage/">산본동 출장마사지</a></li>
        <li><a href="/gunpo/geumjeong-dong-chuljangmassage/">금정동 출장마사지</a></li>
        <li><a href="/gunpo/gwangjeong-dong-chuljangmassage/">광정동 출장마사지</a></li>
        <li><a href="/gunpo/daeya-dong-chuljangmassage/">대야동 출장마사지</a></li>
      </ul>
    </nav>
    <nav class="footer-col" aria-label="지하철역 안내">
      <p class="footer-title">역세권 안내</p>
      <ul>
        <li><a href="/gunpo/geumjeong-station-chuljangmassage/">금정역</a></li>
        <li><a href="/gunpo/sanbon-station-chuljangmassage/">산본역</a></li>
        <li><a href="/gunpo/gunpo-station-chuljangmassage/">군포역</a></li>
        <li><a href="/gunpo/dangjeong-station-chuljangmassage/">당정역</a></li>
      </ul>
    </nav>
  ...
  <div class="footer-bottom">
    <div class="container footer-bottom-inner">
      ...
      <p class="footer-note">경기도 군포시를 안내하는 건전한 방문 관리 사이트이며, 불법적인 요청은 어떤 경우에도 응하지 않습니다.</p>
